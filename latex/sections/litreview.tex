...
\citep{Bonomo2011}.
These structural features motivate our choice to include not only SELIC regime
indicators but also CDS spreads and implied volatility in the state vector, capturing
the multi-dimensional nature of risk in an emerging-market context.
